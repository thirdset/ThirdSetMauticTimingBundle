...
<div class="row">
    <div class="form-group col-xs-12 <?php echo $feedbackClass; ?>">
        ...
        <a href="#" style="margin-left: 1em;" onclick="mQuery('#campaignevent_timing_expression').val('* 09-17 * * 1-5'); return true;" title="Set the expression to 9AM to 5PM, Monday through Friday."><small>Use Work Hours</small></a>
